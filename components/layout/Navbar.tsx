  ...
  return (
    <header className="sticky top-0 z-20 border-b border-gray-200 bg-white/90 backdrop-blur">
      <div className="mx-auto flex max-w-6xl flex-wrap items-center gap-3 px-4 py-4">
        ...
        <div className="order-3 flex w-full flex-wrap items-center justify-start gap-2 text-sm md:order-3 md:w-auto md:justify-end">
        ...
        <nav className="order-2 w-full overflow-x-auto rounded-full bg-white/70 px-2 py-1 text-sm text-gray-700 shadow-[0_8px_24px_rgba(31,41,55,0.08)] md:order-2 md:w-auto">
